...
export const PinterestPrivacyPolicy: React.FC = () => {
  return (
    <>
      <Header />
      <Main>
        CCPA Privacy Policy (Do Not Sell My Personal Information) Under the
        ...
        please contact us. GDPR Privacy Policy (Data Protection Rights) We would
        ...
        participate in, and/or monitor and guide their online activity. Website
        Name does not knowingly collect any Personal Identifiable Information
